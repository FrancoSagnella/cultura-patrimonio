    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8 mt-3">
                <input value="{{ $tipoEstado->descr }}" class="form-control" type="text" name="descr" id="descr">
            </div>
            <div class="col-md-4 mt-3">
                Descripción
            </div>
            <div class="col-md-8 mt-3">
                ...
                <textarea name="text"  class="form-control" cols="30" rows="10">{{ $tipoEstado->text }}</textarea>
            </div>
        </div>
        {{-- Nombre Ingreso input --}}
