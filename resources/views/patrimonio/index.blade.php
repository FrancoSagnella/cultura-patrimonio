...
<div class="container-fluid py-3 contenedor-gris-redondeado">
    ...
    <div class="row">
        <div class="col-2 mt-2"> Nº Patrimonio:
        </div>
        <div class="col-2 mt-2"> Complejo/Edificio:
        </div>
        <div class="col-2 mt-2"> Dependencia:
        </div>
        <div class="col-2 mt-2"> Código Presupuestario:
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-2 mt-2"> Descripción Patrimonio:
        </div>
        <div class="col-2 mt-2"> Unidad Funcional:
        </div>
        <div class="col-2 mt-2"> Responsable:
        </div>
        <div class="col-2 mt-2"> Tipo de Bien:
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-2 mt-2"> Fecha desde:
        </div>
        <div class="col-2 mt-2"> Piso:
        </div>
        <div class="col-2 mt-2"> Estado:
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-2 mt-2"> Fecha hasta:
        </div>
        <div class="col-2 mt-2"> Oficina:
        </div>
    </div>
